...
scripts/gen-answer.sh tests/41 tests/41.a
echo ""
echo "Generating answer for test #42"
scripts/gen-answer.sh tests/42 tests/42.a
echo ""
echo "Generating answer for test #43"
scripts/gen-answer.sh tests/43 tests/43.a
echo ""
echo "Generating answer for test #44"
scripts/gen-answer.sh tests/44 tests/44.a
echo ""
echo "Generating answer for test #45"
scripts/gen-answer.sh tests/45 tests/45.a
echo ""
echo "Generating answer for test #46"
scripts/gen-answer.sh tests/46 tests/46.a
echo ""
echo "Generating answer for test #47"
scripts/gen-answer.sh tests/47 tests/47.a
echo ""
echo "Generating answer for test #48"
scripts/gen-answer.sh tests/48 tests/48.a
echo ""
echo "Generating answer for test #49"
scripts/gen-answer.sh tests/49 tests/49.a
echo ""
echo "Generating answer for test #50"
scripts/gen-answer.sh tests/50 tests/50.a
echo ""
echo "Generating answer for test #51"
scripts/gen-answer.sh tests/51 tests/51.a
echo ""
echo "Generating answer for test #52"
scripts/gen-answer.sh tests/52 tests/52.a
echo ""
echo "Generating answer for test #53"
scripts/gen-answer.sh tests/53 tests/53.a
echo ""
echo "Generating answer for test #54"
scripts/gen-answer.sh tests/54 tests/54.a
echo ""
echo "Generating answer for test #55"
scripts/gen-answer.sh tests/55 tests/55.a
echo ""
echo "Generating answer for test #56"
scripts/gen-answer.sh tests/56 tests/56.a
echo ""
echo "Generating answer for test #57"
scripts/gen-answer.sh tests/57 tests/57.a
echo ""
echo "Generating answer for test #58"
scripts/gen-answer.sh tests/58 tests/58.a
echo ""
echo "Generating answer for test #59"
scripts/gen-answer.sh tests/59 tests/59.a
echo ""
echo "Generating answer for test #60"
scripts/gen-answer.sh tests/60 tests/60.a
echo ""
